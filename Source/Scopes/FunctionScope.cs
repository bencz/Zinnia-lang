...
public class FunctionScope : CodeScopeNode
{
    ...
    public List<Command> Gotos = new();

    public Dictionary<string, Command> Labels = new();
    public List<Identifier> LocalIdentifiers = new();
        ...
        : base(Parent, Code)
    {
        ...
        Type = Function.TypeOfSelf.RealId as TypeOfFunction;
        ReturnLabel = State.AutoLabel;
    }
    ...
    private bool AddConstructorCommands()
    {
