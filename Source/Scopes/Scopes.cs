...
public abstract class IdentifierScope : NonCodeScope
{
    ...
    */
    ...
    protected override string CalculateAssemblyName()
    {
        ...
        return base.CalculateAssemblyName() + "_" + Id.Name;
    }
}
...
public class NamespaceScope : IdentifierScope
{
    ...
    public override Identifier Identifier => Namespace;
...
public abstract class ScopeNode : IdContainer
{
    ...
    public int SourceLength => Code.IsValid ? Code.Length : 0;
}
...
public class PropertyScope : IdentifierScope
{
    ...
    public override IdContainer RealContainer => Parent.RealContainer;

    public override IdentifierAccess DefaultAccess => IdentifierAccess.Public;

    public override Identifier Identifier => Property;

    protected override string CalculateAssemblyName()
    {
        if (!Property.Name.IsValid) return base.CalculateAssemblyName() + "_%Indexer";
        return base.CalculateAssemblyName();
    }
    ...
    private bool CreateScopeForAccessor(Function Func, CodeString Code)
    {
        if (Func.HasCode)
        {
    ...
    private Function CreateFunctionForAccessor(string Name, CodeString Declaration, TypeOfFunction Type,
    ...
    public Function CreateGetter(CodeString Declaration, CodeString Code,
    ...
    public bool AutoImplement()
    {
        ...
        var Name = new CodeString(Property.Name + "_%Value");
