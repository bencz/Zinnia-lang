...
public class CompilerPlugin : ExpressionPlugin, IPluginDeclarationHandler
{
    ...
    public bool AllPathGetsValue(Identifier Var, ExpressionNode Node)
    {
        ...
        if (Node is OpExpressionNode)
        {
            ...
            else if (Op == Operator.Address || Op == Operator.Reference_Unsafe ||
                     Op == Operator.Reference_IdGetsAssigned)
            {
    ...
    private ExpressionNode Extract(ExpressionNode Node, ref bool Extracted)
    {
    ...
    private ExpressionNode Extract(ExpressionNode Node)
    {
        var Extracted = false;
    ...
    private bool CheckUsedIdNodes(ExpressionNode Node)
    {
    ...
    private void MarkIdNodesAssigned(ExpressionNode Node)
    {
    ...
    private SimpleRecResult ExtractPropertyFunction_OnlyId(ref ExpressionNode Node, bool Setter)
    {
        var IdNode = Node as IdExpressionNode;
    ...
    private ExpressionNode GetGetterForSetter(ExpressionNode Node)
    {
        var IdNode = Node as IdExpressionNode;
        ...
        out ExpressionNode Dst, out ExpressionNode Src)
    {
        ...
        if (IsClassMemberNode(LinkedNode.Node))
        {
            ...
            var DstCh = new[] { Dst, MemberIdNode1 };
            var SrcCh = new[] { Src, MemberIdNode2 };
