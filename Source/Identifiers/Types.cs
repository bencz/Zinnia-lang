...
public abstract class Type : Identifier
{
    ...
    public override Identifier TypeOfSelf => Container.GlobalContainer.CommonIds.TypeOfType;
...
public class NullType : AutomaticType
{
    public NullType(IdContainer Container, CodeString Name)
        : base(Container, Name)
    {
        UndeclaredIdType = UndeclaredIdType.Null;
    }
    ...
    public override TypeConversion CanConvert(Identifier To)
    {
        ...
        if (RTo is PointerType || RTo is TypeOfFunction ||
            (RTo.TypeFlags & TypeFlags.ReferenceValue) != 0)
            return TypeConversion.Automatic;
...
public class PointerType : Type
{
    ...
    public Type Child => Children[0].RealId as Type;
...
public abstract class BuiltinType : Type
{
    ...
    public override bool HasScopes => UnderlyingType != null && UnderlyingType.HasScopes;
...
public class ObjectType : BuiltinType
{
    public ObjectType(IdContainer Container, CodeString Name)
        : base(Container, Name)
    {
        UndeclaredIdType = UndeclaredIdType.Object;
        TypeFlags |= TypeFlags.ReferenceValue;
        ConstValueType = ConstValueType.Unknown;
        Size = Align = Container.State.Arch.RegSize;
    }
...
public class StringType : BuiltinType
{
    public StringType(IdContainer Container, CodeString Name)
        : base(Container, Name)
    {
        UndeclaredIdType = UndeclaredIdType.String;
        TypeFlags |= TypeFlags.ReferenceValue;
        ConstValueType = ConstValueType.String;
        Size = Align = Container.State.Arch.RegSize;
    }
...
public class CharType : BuiltinType
{
        ...
        : base(Container, Name)
    {
        Size = 2;
        Align = 2;
        ConstValueType = ConstValueType.Char;
        UndeclaredIdType = UndeclaredIdType.Char;
    }
...
public class FloatType : NumberType
{
        ...
        : base(Container, Name, Size)
    {
        if (Size == 4)
        {
            ConstValueType = ConstValueType.Float;
            UndeclaredIdType = UndeclaredIdType.Single;
        }
        else if (Size == 8)
        {
            ConstValueType = ConstValueType.Double;
            UndeclaredIdType = UndeclaredIdType.Double;
        }
        else
        {
...
public class BooleanType : BuiltinType
{
        ...
        : base(Container, Name)
    {
        Size = 1;
        Align = 1;
        ConstValueType = ConstValueType.Boolean;
        UndeclaredIdType = UndeclaredIdType.Boolean;
    }
...
public class FlagType : EnumType
{
    ...
    {
        DeclaredIdType = DeclaredIdType.Flag;
    }
...
public class EnumType : Type
{
    ...
    public EnumType(IdContainer Container, CodeString Name, Identifier TypeOfValues)
        : base(Container, Name)
    {
        Children = new[] { TypeOfValues };
        ConstValueType = ConstValueType.Integer;
        DeclaredIdType = DeclaredIdType.Enum;
        Update();
    }
    ...
    public override void Update()
    {
        Size = TypeOfValues.Size;
        Align = TypeOfValues.Align;
    }
    ...
    public ConstVariable GetValue(string Name)
    {
        ...
        if (Res.Count == 1) return Res[0].Identifier as ConstVariable;
        throw new ApplicationException();
    }
...
public class ReferenceType : Type
{
    ...
    public ReferenceType(IdContainer Container, CodeString Name, Identifier Child, ReferenceMode Mode,
        bool DoUpdate = true)
        : base(Container, Name)
    {
        Setup();
...
public class TypeOfFunction : Type
{
        ...
        : base(Container, new CodeString())
    {
        ...
        UndeclaredIdType = UndeclaredIdType.Function;
        Size = Container.State.Arch.RegSize;
        Align = Size;
    ...
    public Type RetType => Children[0].RealId as Type;
...
public abstract class ArrayType : BuiltinType
{
    ...
    public ArrayType(IdContainer Container, Identifier TypeOfVals)
        : base(Container, new CodeString())
    {
        Children = new[] { TypeOfVals };
    }

    public Type TypeOfValues => Children[0].RealId as Type;
...
public class RefArrayType : ArrayType
{
        ...
        : base(Container, TypeOfVals)
    {
        ...
        Align = Arch.RegSize;
        Size = Arch.RegSize;
        UndeclaredIdType = UndeclaredIdType.RefArrayType;
...
public class NonrefArrayType : ArrayType
{
        ...
        : base(Container, TypeOfVals)
    {
        ...
        Dimensions = Lengths == null ? 1 : Lengths.Length;
        UndeclaredIdType = UndeclaredIdType.NonrefArrayType;
