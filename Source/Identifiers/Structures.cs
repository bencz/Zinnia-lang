...
public struct StructureBase
{
    ...
    public StructureBase(CodeString Declaration, CodeString Name = new(),
...
public abstract class StructuredType : Type
{
    ...
    public string FunctionTableLabel => AssemblyName + "_%FunctionTable";
    ...
    public void SearchBase(IdContainer Container, string Name, List<IdentifierFound> Out,
    ...
    public void CalcVirtuals()
    {
        ...
        if ((TypeFlags & TypeFlags.ReferenceValue) == 0)
...
public class ClassType : StructuredType
{
        ...
        : base(Container, Name)
    {
        ...
        DeclaredIdType = DeclaredIdType.Class;
    ...
    public override TypeConversion CanConvert(Identifier To)
    {
        ...
        if (Identifiers.IsSubtypeOf(To, this)) return TypeConversion.Convertable;
...
public class StructType : StructuredType
{
    ...
    {
        this.Children = Children;
        DeclaredIdType = DeclaredIdType.Struct;
    }
...
public class NonstaticFunctionType : TupleType
{
        ...
        : base(Container, new CodeString(), true)
    {
        ...
        UndeclaredIdType = UndeclaredIdType.NonstaticFunctionType;
    ...
    public Identifier Child => Children[0];
...
public class PointerAndLength : TupleType
{
    ...
    {
        UndeclaredIdType = UndeclaredIdType.PointerAndLength;
    ...
    public Identifier Child => PointerType.RealId.Children[0];
    ...
    public override TypeConversion CanConvert(Identifier To)
    {
        ...
        if (To.RealId is PointerType)
        {
            ...
            return RChild.CanConvert(PTo.Child);
        }
...
public class TupleType : StructType
{
    ...
    public TupleType(IdContainer Container, CodeString Name, bool Named)
        : base(Container, Name)
    {
        UndeclaredIdType = UndeclaredIdType.Tuple;
        DeclaredIdType = DeclaredIdType.Unknown;
        this.Named = Named;

        BaseStructures = new StructureBase[0];
    }
        ...
        : base(Container, new CodeString())
    {
        UndeclaredIdType = UndeclaredIdType.Tuple;
        DeclaredIdType = DeclaredIdType.Unknown;
        StructuredScope = StructuredTypeScope;
        Update();
    }
    ...
    public override TypeConversion CanConvert(Identifier To)
    {
        ...
        if (V != null)
        {
            ...
            if (Members.Count == 0) return TypeConversion.Automatic;
