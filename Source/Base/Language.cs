...
public struct ResultSkippingManager
{
    ...
    public int RemainingLength => Back ? Current + 1 : String.Length - Current;

    public char CurrentChar => String[Current];
    ...
    public ResultSkippingManager(IList<IResultSkippingHandler> SkippingHandlers, StringSlice String, bool Back = false)
    {
        ...
        DoNotSkipBrackets = false;

        this.String = String;
        Current = -1;
        this.Back = Back;
        ContinueAt = Back ? String.Length - 1 : 0;
        DontCheckNext = false;
    }
...
public class LanguageNode
{
    ...
    public LanguageNode(Language Language, LanguageNodeFlags Flags = LanguageNodeFlags.None)
    {
        ...
        SkippingHandlers = new List<IResultSkippingHandler>();
        this.Flags = Flags;
    }
    ...
    private void GetObjects<T>(List<T> List) where T : class
    {
        ForEach(x =>
        {
            if (x is T)
