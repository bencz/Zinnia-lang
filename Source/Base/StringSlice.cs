...
public struct StringSlice
{
    ...
    public bool IsValid => String != null;
    ...
    {
        Helper.Verify(String.Length, Index, Length);
        this.String = String;
        this.Index = Index;
        this.Length = Length;
    }
    ...
    {
        Helper.Verify(Length, Index);
        return new StringSlice(String, this.Index + Index, Length - Index);
    }
    ...
    private bool CanContain(string[] CmpWith, bool Back)
    {
        for (var i = 0; i < CmpWith.Length; i++)
        {
