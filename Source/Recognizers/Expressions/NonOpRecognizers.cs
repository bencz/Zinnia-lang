...
public class TestScopeRecognizer : LanguageNode, IExprRecognizer
{
    public TestScopeRecognizer(LanguageNode Parent)
        : base(Parent)
    {
        NewLineRight = Operators = new[] { "testscope" };
    }
...
public class CheckedUncExprRecognizer : LanguageNode, IExprRecognizer
{
    public CheckedUncExprRecognizer(LanguageNode Parent)
        : base(Parent)
    {
        Operators = new[] { "checked", "unchecked" };
...
public class BracketGroupRecognizer : LanguageNode, IGroupRecognizer
{
    ...
    public static NodeGroup GetGroups(PluginRoot Plugin, CodeString Code, char BracketLeft = '{',
        char BracketRight = '}')
    {
...
public class BracketRecognizer : LanguageNode, IExprRecognizer, IIdRecognizer, IResultSkippingHandler
{
    ...
    public BracketRecognizer(LanguageNode Parent, GenericBracketSkipOptions GenericBracketSkipMode = new())
        : base(Parent)
    {
        GenericBracketSkipOptions = GenericBracketSkipMode;
    }
    ...
    private static bool Check(CompilerState State, CodeString Code)
    {
    ...
    private SkippingHandlerResult SkipBracket(ref ResultSkippingManager RSM)
    {
        if (RSM.Back)
        {
...
{
    private CallRecognizer CallRecognizer;
