...
public static class NCExpressions
{
        ...
        ExpressionNode[] Indices, ExpressionNode[] Dimensions, CodeString Code)
    {
        ...
        for (var i = Dimensions.Length - 1; i >= 0; i--)
        {
            ...
            {
                var MulCh = new[] { Chi, Dimensions[j] };
        ...
        for (var i = Dimensions.Length - 1; i >= 0; i--)
        {
            ...
            if (MulVar != null && i != 1)
            {
                ...
                if (i == Dimensions.Length - 1)
                {
                    ...
                    AssignmentCh = new[] { Dst, Dimensions[i] };
                }
                else
                {
                    var Dst = Plugin.NewNode(new IdExpressionNode(MulVar, Code));
        ...
        ExpressionNode Array, int Index, CodeString Code)
    {
        ...
        if (Type is RefArrayType)
        {
            ...
            var DimensionsCh = new[] { Array, DimensionsIdNode };
            ...
            var IndexCh = new[] { Dimensions, IndexValue };
    ...
    {
        var Nodes = new[] { Min, Node, Max };
        var Operators = new[] { Operator.LessEqual, Operator.LessEqual };
